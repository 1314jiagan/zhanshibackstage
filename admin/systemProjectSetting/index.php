        ...
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="people" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'name',title: '公司名称',fixed: 'left'}
                ,{field:'contactphone',title: '联系电话',fixed: 'left'}
                ,{field:'phone',title: '手机',fixed: 'left'}
                ,{field:'people',title: '联系人',fixed: 'left'}
                ,{field:'qq',title: 'qq',fixed: 'left'}
                ,{field:'email',title: 'email',fixed: 'left'}
                ,{field:'address',title: '地址',fixed: 'left'}
                ,{title:'操作',align:'center', fixed: 'right' ,width:170,toolbar: '#table-useradmin-webuser'}
            ]]
            ,page: true
            ,limit: 5
            ,limits: [5, 10, 15]
